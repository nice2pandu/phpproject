                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button data-value="{{$user->email}}" type="submit"   class="btn reset btn-success btn-sm m-1" data-toggle="tooltip" data-placement="top" title="Reset Credit Balance" href="">
        ...
        jQuery(document).ready(function(){
            $('.reset').on('click', function(e){
                ...
                jQuery.confirm({
                    ...
                    buttons: {
                        confirm: function () {
                            url = "{{route('resetCreditBalance.edit')}}";
                            var db = that.attr('data-value');
                            console.log(db);
                            $.ajax({
                                type: "POST",
                                url: url,
