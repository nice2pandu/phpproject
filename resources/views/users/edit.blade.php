                    ...
                    <h6 class="heading-small text-muted mb-4">User information</h6>
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        {{ Form::label('credits', 'Credit', ['class' => 'form-control-label']) }}
                                        {{ Form::text('credits', $user->credits, ['class' => 'form-control']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="ip_restriction" value="1" {{ $user->ip_restriction ? 'checked' : ''}} class="custom-control-input" id="ip_restriction">
                                        {{ Form::label('ip_restriction', 'IP Restriction', ['class' => 'custom-control-label']) }}
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="detail_search" value="1" {{ $user->detail_search ? 'checked' : ''}} class="custom-control-input" id="detail_search">
                                        {{ Form::label('detail_search', 'Detail Search', ['class' => 'custom-control-label']) }}
                                    </div>
                                </div>
                                @can('update-user')
                                <div class="col-md-12">
