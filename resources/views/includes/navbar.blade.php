    ...
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                <!-- Nav items -->
                <ul class="navbar-nav">
                    @if(\Illuminate\Support\Facades\Auth::user()->detail_search == 1)
                    <li class="nav-item">
...
{{--                        </li>--}}
                    ...
                    @endcan
                    @canany(['view-permission', 'can-upload-bulk'])
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('bulk*')) ? 'active' : '' }}" href="#navbar-users"  data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-users">
                        ...
                        <div class="collapse" id="navbar-users">
                            <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('bulk.upload')}}" class="nav-link"><span class="sidenav-mini-icon">D </span><span class="sidenav-normal">Upload Data</span></a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="{{route('bulk.search')}}" class="nav-link"><span class="sidenav-mini-icon">D </span><span class="sidenav-normal">Search</span></a>
                                    </li>
                    ...
                    @canany(['view-user', 'create-user'])
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('history*')) ? 'active' : '' }}" href="{{route('history')}}">
                                <i class="fas text-primary fa-history text-primary"></i>
                                <span class="nav-link-text">Search History</span>
                            </a>
                        </li>
                    @endcan
